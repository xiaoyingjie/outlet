      ...
      <div slot="content">
        <div class="content-wraper">
          ...
          <div class="item-content" style="margin-top: 20px;text-align: center">
            <el-button size="small" :disabled="userRow.checkstate2" type="primary" @click="confirm">确认</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      confirm () {
        if (this.userRow.checkstate1 <= 0) {
          this.$message({
            message: '组长审核未通过，无法进行审核操作',
            type: 'warning'
          })
          return
        }
        ...
        let args = {
          ...
          zzshid: this.userRow.zzshid
        }
        api.auditInsertMinistryAuditA(Object.assign({}, args, this.shInfo)).then(res => {
